...
//  MyLocations
//
//  Created by Ike Mattice on 6/21/16.
...
class HudView: UIView {
    ...
    //class methods can be used when there is not a specific instance of that class
    ...
    override func drawRect(rect: CGRect) {
        ...
        let boxRect = CGRect(
            //calculates the center of the screen and places the rect there
