...
class LocationsViewController: UITableViewController {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController = {
        ...
        let categoryFilter = NSSortDescriptor(key: "category", ascending: true)
        let dateFilter = NSSortDescriptor(key: "date", ascending: true)
        fetchRequest.sortDescriptors = [categoryFilter, dateFilter]
